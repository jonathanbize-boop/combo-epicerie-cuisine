...
function combo_defaults() {
	return array(
		...
		// Horaires
		'hours_f1'        => 'Mar, jeu, sam : 10h – 15h',
		'hours_f2'        => 'Mer, ven : 10h – 18h',
		...
		'home_lead'       => "Sous le même toit, au hameau de l'Usine : une <strong>épicerie fine et du monde</strong>, une <strong>cave à vin</strong> et une <strong>cantine 100 % fait maison</strong> qui fait voyager vos papilles, à deux pas de Dieulefit.",
		...
		'uni2_text'       => 'Une cuisine du monde généreuse et 100 % fait maison, servie le midi du mardi au samedi. Le menu change au gré du marché et des envies du chef.',
		...
		'c2_text'         => "Spritz, caïpirinha, vins ou bières artisanales… L'alcool se déguste ici uniquement avec quelque chose à manger. Bien manger, bien boire : dans cet ordre !",
		...
		'lieu_text'       => "Au hameau de l'Usine, sur la route entre La Bégude-de-Mazenc et Dieulefit, COMBO a posé ses bocaux dans un lieu atypique chargé d'histoire. Bois clair, théières chinées, grandes tablées et rayons généreux : on s'y sent immédiatement chez soi.",
		...
		'lieu_li2'        => '<strong>Cantine le midi</strong> du mardi au samedi, avec un menu qui voyage chaque semaine.',
		...
		'cta_text'        => "Passez nous voir au hameau de l'Usine, appelez-nous pour connaître le plat du jour, ou suivez nos aventures gourmandes sur Instagram.",
		// Épicerie
		...
		'ep_cta_text'     => "Dites-le nous : on adore partir à la chasse aux trésors pour nos clients. Appelez-nous ou passez nous voir au hameau de l'Usine.",
		// Cantine
		...
		'cu_chef_lead'    => "Curry thaï un jour, tajine le lendemain, poisson laqué façon teriyaki le surlendemain… À la cantine COMBO, le menu change au rythme du marché, des saisons et des inspirations du chef.",
		...
		'cu_h3_text'      => "Le bar sert cocktails, vins et bières artisanales uniquement en accompagnement d'un plat. La gourmandise d'abord !",
		'cu_bar_title'    => 'Un verre, oui — mais jamais le ventre vide !',
		'cu_bar_lead'     => "Caïpirinha, spritz, gin tonic, vins de vignerons et bières brassées dans la région : le bar de COMBO a tout d'un grand… à un détail près.",
		'cu_bar_text'     => "Ici, l'alcool accompagne toujours quelque chose à manger. C'est notre façon de garder une ambiance douce et familiale, où l'on vient autant pour discuter que pour se régaler. Et pour les sans-alcool : limonades artisanales, jus locaux, thés et cafés vous attendent toute la journée.",
		'cu_bar_sticker'  => 'Spritz & caïpi',
		'cu_gal_title'    => 'Quelques plats passés par nos fourneaux',
		'cu_quote'        => "« Service le midi, du mardi au samedi, de 12h à 14h. Pas de réservation compliquée : on arrive, on commande, on se régale. »",
		'cu_cta_hand'     => 'À table !',
		'cu_cta_title'    => 'Le plat du jour vous attend',
		'cu_cta_text'     => "Rejoignez-nous au hameau de l'Usine, à 5 minutes de Dieulefit. Et pour connaître le menu avant de venir, direction Instagram.",
		// Contact
		'co_hand'         => 'On vous attend !',
		'co_title'        => 'Infos pratiques & contact',
		'co_lead'         => "Au hameau de l'Usine, à 5 minutes de Dieulefit et 20 minutes de Montélimar : la Drôme provençale a son repaire gourmand.",
		'co_parking'      => 'Sur la D540, entre La Bégude-de-Mazenc et Dieulefit. Parking à proximité immédiate.',
		'co_d1_tag'       => '5 min',
		'co_d1_title'     => 'Depuis Dieulefit',
		'co_d1_text'      => "Prenez la D540 direction La Bégude-de-Mazenc : COMBO vous attend au hameau de l'Usine, sur votre droite.",
		'co_d2_tag'       => '10 min',
